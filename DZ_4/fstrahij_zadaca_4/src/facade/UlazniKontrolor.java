...
public class UlazniKontrolor {
    ...
    private int br = 24, bs = 80, brk = 2, pi = 50, tcd = 0, kmax = 100, kmin = 5, kpov = 5;
    private ThingsOfFOI tof = ThingsOfFOI.getInstance();

    public int provjera(String[] args) {
